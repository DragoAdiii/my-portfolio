  ...
  return (
    ...
    >
      ...
      <div className="px-4 w-150 ">
        ...
        <form action="https://formsubmit.co/adityamamluskar@gmail.com" method="POST" 
         className="space-y-6 ">
          <div className="relative">
            <input
              ...
              required
              className="w-full bg-white/10 border border-r-white/10 rounded px-4 py-3 text-white focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"
            />
          </div>
          <div className="relative">
            <input
